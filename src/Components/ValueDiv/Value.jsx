...
import simpl2 from '../../Assets/simpl2.png'
...
<div className='singleGrid rounded-[10px] hover:bg-[#eeedf8] p-[1.5rem]'>
...
<div className='flex items-center gap-3'>
<div className='imgDiv p-[4px] rounded-[.8rem] bg-[#dedef8] h-[40px] w-[40px] flex items-center justify-center'>
<img src={simpl2} alt='' className='w-[70%]'/>
</div>

<span className='font-semibold text-textColor text-[18px]'>Simplicity</span>
</div>
<p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
 We believe in making thing better for everyone, even if just by a little bit!
</p>
</div>
...
<p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
 We work on the basis of creating trust which can be nuetured through authenticity and transparency
</p>
</div>
...
<div className='card mt-[2rem] flex justify-between bg-blueColor p-[5rem] reonded-[10px]'>
